...
?>
                    ...
                    <div class="graph">
                        <div class="graph-setting">
                            ...
                            <div class="box-setting">
                                <div class="elem-content" object="temptAndHumy" type="temptInBox">
                                     <button type="button" name="button" <?php echo 'class="submit butn sendData '.($cmdResult ? "active ":"").'"'; ?> >Đặt nhiệt độ</button>
                ...
                <div class="col-lg-12 adv-option-content">
                    <div class="graph">
                        <div class="graph-setting">
                            ...
                            <div class="box-setting">
                                <div class="elem-content" object="temptAndHumy" type="humidity">
                                    <button type="button" name="button" <?php echo 'class="submit butn sendData '.($cmdResult ? "active ":"").'"'; ?>>Đặt độ ẩm</button>
                                    <div class="box-setting-val">
    ...
    <div class="field-alert" id="field-alert"></div>
<?php 
